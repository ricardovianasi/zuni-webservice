 ...
 */
class Location extends \Application\Entity\Location implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Location' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\Location' . "\0" . 'name');
        }
